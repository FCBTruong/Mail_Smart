...
export default function App() {
  ...
  const onChangeGold = (e) => {
    var newData = { ...data };
    newData.gift.gold = parseInt(e.target.value);
    setData(newData);
  };

  const onChangeDiamond = (e) => {
    var newData = { ...data };
    newData.gift.diamond = parseInt(e.target.value);
    setData(newData);
  };
  ...
  const onChangeTicketNum = (e) => {
    var newData = { ...data };
    newData.gift.tickets[0].ticketNum = parseInt(e.target.value);
    setData(newData);
  }

  const onChangeTicketType = (e) => {
    var newData = { ...data };
    newData.gift.tickets[0].ticketType = parseInt(e.target.value);
    setData(newData);
  }
